...
import ChangePasswordForm from "@/components/admin/v2/ChangePasswordForm";
import useAdminUser from "@/api/user/useAdminUser";
import useChangeAdminUserPassword from "@/api/user/useChangeAdminUserPassword";
...
const ChangePasswordPage = () => {
  ...
  const handleSubmit = async (data: AdminChangePasswordRequest) => {
    try {
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-1">
              กำหนดรหัสผ่านใหม่สำหรับ {user.name}
            </p>
          </div>
          <button
