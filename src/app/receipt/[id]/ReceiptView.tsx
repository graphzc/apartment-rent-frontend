...
const ReceiptView = ({ id }: ReceiptViewProps) => {
  ...
  if (data.status !== "PAID") {
    return (
      <div className="text-center py-12">
        <p className="text-yellow-600">ใบเสร็จนี้ยังไม่สามารถดูได้ เนื่องจากยังไม่ได้ชำระเงิน</p>
        <button 
          onClick={() => router.back()}
          className="mt-4 bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded-lg"
        >
      ...
      >
        ...
        <div className="text-center border-b-2 border-gray-800 pb-6 mb-8">
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-800">ระบบจัดการอพาร์ทเม้นท์</h1>
          ...
          <div className="bg-green-100 inline-flex items-center px-6 py-2 rounded-full">
            ...
            <span className="text-green-800 font-semibold text-lg">ใบเสร็จรับเงิน / RECEIPT</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-8 mb-8">
          <div>
            <h3 className="text-lg font-semibold text-gray-800 mb-4 border-b pb-2">ข้อมูลใบเสร็จ</h3>
            <div className="space-y-3">
              <div className="flex">
                <span className="text-gray-600 w-32">เลขที่ใบเสร็จ:</span>
                <span className="font-semibold">#{billing.billingReference}</span>
              </div>
              <div className="flex">
              ...
              <div className="flex">
                ...
                <span>{paidPayment ? formatDateShort(paidPayment.createdAt) : formatDateShort(billing.updatedAt)}</span>
              </div>
            </div>
          </div>
          <div>
            <h3 className="text-lg font-semibold text-gray-800 mb-4 border-b pb-2">ข้อมูลลูกค้า</h3>
            <div className="space-y-3">
              <div className="flex">
        ...
        {/* Payment Details */}
        <div className="mb-8">
          <h3 className="text-lg font-semibold text-gray-800 mb-4 border-b pb-2">รายละเอียดการชำระเงิน</h3>
            ...
            <table className="w-full">
              ...
              <tfoot>
                <tr className="border-t-2 border-gray-800">
                  <td colSpan={3} className="py-4 px-2 text-right font-bold text-lg">
                    ยอดรวมทั้งสิ้น:
                  </td>
        ...
        {/* Payment Method */}
        <div className="mb-8">
          <h3 className="text-lg font-semibold text-gray-800 mb-4 border-b pb-2">วิธีการชำระเงิน</h3>
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-green-700 text-sm">
                  ชำระเมื่อ: {paidPayment ? formatDate(paidPayment.createdAt) : formatDate(billing.updatedAt)}
                </p>
              </div>
            </div>
          </div>
